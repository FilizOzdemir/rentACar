...
public class ColorManager implements ColorService {
	...
	public Result update(UpdateColorRequest updateColorRequest) {
		...
		this.colorDao.save(color);
		return new SuccessResult(BusinessMessages.ColorMessages.COLOR_UPDATED);//renk güncellendi
	}
	...
	@Override
	public DataResult<List<ListColorDto>> getAll() {//tümünü listeleme
    ...
    private void checkIfColorExists(String colorName) {
        if (this.colorDao.existsColorByNameIgnoreCase(colorName)) {
            throw new BusinessException(BusinessMessages.ColorMessages.COLOR_EXIST);//Girdiğiniz Renk Mevcuttur !
        }
    }
